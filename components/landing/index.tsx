...
function Landing() {
  return (
    <section className="relative min-h-full min-w-full">
      <Video />
      <div className="absolute min-h-screen min-w-full bg-gradient-to-b from-[#000000a6] via-[#000000a6] to-[#00000000]" />
